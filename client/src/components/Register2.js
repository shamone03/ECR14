...
const Register2 = () => {
    ...
    const [houseNo, setHouseNo] = useState(houseNo)
    ...
    const validateHouseNo = (e, houseNo) => {
        e.preventDefault()
        console.log(houseNo)
                ...
                <div className={'row'}>
                    <div className={'col-lg-12'}>
                        <Form.Group className={"mb-3 mt-5"}>
                            ...
                            <Form.Control style={aptNoStyle} className={styles.inputStyle} type={"text"} placeholder={"example: J606"} onChange={e => validateHouseNo(e, e.target.value)}/>
                        </Form.Group>
                    </div>
                </div>
            </Form>
