            ...
            <div className={`d-flex justify-content-center align-items-center ${styles.formWrapper} mx-auto`}>
                <Form className={`mx-auto d-flex flex-column justify-content-between align-items-center`}>
                    <Form.Group className={"mb-3 mt-5"}>
                        ...
                        <Form.Control style={aptNoStyle} className={styles.inputStyle} type={"text"} placeholder={"example: J606"} onChange={e => setHouseNo(e.target.value)}/>
                    </Form.Group>
                    <Form.Group className={'mb-3'}>
                        <Form.Label>Enter email</Form.Label>
                        <Form.Control style={emailStyle} className={styles.inputStyle} type={"text"} placeholder={'example@email.com'} onChange={e => setEmail(e.target.value)}/>
                    </Form.Group>
                    <Form.Group className={'mb-3'}>
                    ...
                    <Form.Group className={'mb-3'}>
                        ...
                        <Form.Control style={passwordStyle} className={styles.inputStyle} type={"password"} onChange={e => setPassword(e.target.value)}/>
                    </Form.Group>
                    <Form.Group className={'mb-3'}>
