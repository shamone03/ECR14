...
const Register = () => {
    ...
    const [residentTypeStyle, setResidentTypeStyle] = useState({})
    ...
    useEffect(() => {
        console.log({
            houseNo, residentType, number, password, passwordConfirm, email, age
        })
    }, [houseNo, residentType, number, password, passwordConfirm, email, age])
            ...
            <div className={`d-flex justify-content-center align-items-center ${styles.formWrapper} mx-auto`}>
                <Form className={`d-flex flex-column justify-content-between align-items-center w-100`}>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control style={ageStyle} className={styles.inputStyle} type={'number'} onChange={(e) => validateAge(e.target.value)}/>
                    </Form.Group>
